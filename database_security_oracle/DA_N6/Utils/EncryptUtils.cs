...
namespace DA_N6.Utils
{
    internal class EncryptUtils
    {
        ...
        /// <summary>
        /// Lay key ma hoa hieu luc (phai trung voi key su dung trong Oracle DB)
        /// Oracle DB dang su dung key = 9 trong ENCRYPT_PKG.P_REGISTER_USER
        /// </summary>
        public static int GetEffectiveKey()
        {
            return 9; // Phai trung voi key trong Oracle: F_ENCRYPT_DB(p_username, 9)
        }
