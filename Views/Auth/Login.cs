    ...
    public partial class Login : Form
    {
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Mã hóa tầng 1 tại ứng dụng (với key=7)
                    ...
                    // Mã hóa tầng 2 bằng NAM_DOAN (với key=7)
                    ...
                    // MÃ HÓA LẦN 2 - giống hệt đăng ký
                    object encUserLv2 = DatabaseHelper.ExecuteFunction(
                        ...
                        new OracleParameter("p_key", OracleDbType.Int32, 7, ParameterDirection.Input)
                    );
                    ...
                    // Login user thật VỚI TÊN ĐÃ MÃ HÓA 2 LẦN
                    ...
                    // Dùng finalUser (đã mã hóa 2 lần)
                    string finalUserLv2 = finalUser; // KHÔNG MÃ HÓA LẠI!
                    ...
                    // 2. Lấy userId từ tên đã mã hóa 2 lần
